  ...
  return (
    <div className="flex flex-col w-full">
      <div className="w-1/4 p-2">
        ...
        <select onChange={(e) => {setDecade(Number(e.target.value))}} id="countries" className="w-1/4 bg-gray-50 border text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
          {renderDecades()}
        </select>
    </div>
